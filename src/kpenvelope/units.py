...
The round trip is exact and asserted in the tests, along with the
worked value used throughout the documentation
(4.6e13 cm^-2 = 0.46 nm^-2).
"""
...
def sheet_density_from_cm2(ps_cm2):
    """Sheet density in nm^-2 from a value in cm^-2 (exact: x 1e-14)."""
    return ps_cm2 * 1e-14


def sheet_density_to_cm2(ps_nm2):
    """Sheet density in cm^-2 from a value in nm^-2 (exact: x 1e14)."""
    return ps_nm2 * 1e14
